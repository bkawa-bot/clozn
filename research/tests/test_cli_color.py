...
HERE = os.path.dirname(os.path.abspath(__file__))            # research/tests
RESEARCH = os.path.dirname(HERE)                              # research
REPO = os.path.dirname(RESEARCH)                              # repo root (clozn_cli.py lives here)
sys.path.insert(0, REPO)

import clozn_cli as cli                                       # noqa: E402
